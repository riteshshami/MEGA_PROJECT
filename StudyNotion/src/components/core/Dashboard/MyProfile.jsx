...
const MyProfile = () => {
  ...
  return (
    <>
      <h1 className="text-richblack-5 text-3xl font-semibold p-[24px] -translate-x-4">
        My Profile
      </h1>
      ...
      <div className="lg:w-[792px] lg:h-[126px] bg-richblack-700 rounded-[8px] border-[1px] text-richblack-5 flex flex-row justify-between p-[24px] mb-[20px]">
        <div className="flex flex-row gap-5">
          <img
            ...
            className="aspect-square w-[78px] rounded-full object-cover shadow-md shadow-richblack-900"
            loading="lazy"
          />
      ...
      {/* Section 3 */}
      <div className="lg:w-[792px] lg:h-[240px] bg-richblack-700 rounded-[8px] border-[1px] text-richblack-5 flex flex-col justify-between gap-5 p-[24px] mb-[20px]">
        <div className="flex flex-row justify-between">
